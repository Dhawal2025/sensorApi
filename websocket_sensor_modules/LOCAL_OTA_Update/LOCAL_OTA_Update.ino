...
const char* PSWD = "11TH@2K19";

// S3 Bucket Config
String host = "172.16.168.29"; // Host => bucket-name.s3.region.amazonaws.com
int port = 5000; // Non https. For HTTPS 443. As of today, HTTPS doesn't work.
String bin = "/Blink.ino.bin"; // bin file name with a slash in front.
